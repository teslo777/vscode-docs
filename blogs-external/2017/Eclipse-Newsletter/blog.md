...
To simplify the implementation of language servers and clients there are libraries or SKDs for the client and server part. These libraries are provided for different languages. For example, we maintain a [language client npm module](https://www.npmjs.com/package/vscode-languageclient) to ease the integration of a language server into a VS Code extension and another [language server npm module](https://www.npmjs.com/package/vscode-languageserver) to write a language server using Node.js. This is the current [list](https://github.com/Microsoft/language-server-protocol/wiki/Protocol-Implementations#sdks) of support libraries.
...
To deepen the collaboration, Microsoft hosted a Hackathon at its Zurich development center in July 2016 with participants from Microsoft, RedHat, IBM, and CodeEnvy. The goal was to collaborate on a Java language server that was seeded by RedHat and can be used in EclipseChe, Orion and VS Code. We made great progress during this week as described in this [blog](https://developers.redhat.com/blog/2016/08/01/a-week-of-hacking-the-java-language-server/). For us it was great to see and code with our old friends from IBM again.

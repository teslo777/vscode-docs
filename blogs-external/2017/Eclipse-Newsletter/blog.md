...
To deepen the collaboration, Microsoft hosted a Hackathon at its Zurich development center in July 2016 with participants from Microsoft, RedHat, IBM, and CodeEnvy. The goal was to collaborate on a Java language server that was seeded by RedHat and can be used in EclipseChe, Orion and VS Code. We made great progress during this week as described in this [blog](https://developers.redhat.com/blog/2016/08/01/a-week-of-hacking-the-java-language-server/). For us was great to see and code with our old friends from IBM again.
